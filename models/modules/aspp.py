...
class ASPP(nn.Module):
    ...
    def forward(self, feature_map):
        ...
        # (shape: (batch_size, 256, h/16, w/16))
        out_img = F.upsample(out_img, size=(
            feature_map_h, feature_map_w), mode="bilinear")
...
class ASPP_Bottleneck(nn.Module):
    def __init__(self, hidden_dim):
        ...
        self.conv_3x3_1 = nn.Conv2d(4*512, 256, kernel_size=3,
                                    stride=1, padding=6, dilation=6)
        self.bn_conv_3x3_1 = nn.BatchNorm2d(256)

        self.conv_3x3_2 = nn.Conv2d(4*512, 256, kernel_size=3,
                                    stride=1, padding=12, dilation=12)
        self.bn_conv_3x3_2 = nn.BatchNorm2d(256)

        self.conv_3x3_3 = nn.Conv2d(4*512, 256, kernel_size=3,
        ...
        self.conv_1x1_3 = nn.Conv2d(1280, hidden_dim, kernel_size=1)
        self.bn_conv_1x1_3 = nn.BatchNorm2d(hidden_dim)
